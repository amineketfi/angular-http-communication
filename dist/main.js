...
let AddBookComponent = class AddBookComponent {
    ...
    saveBook(formValues) {
        ...
        newBook.bookID = 0;
        console.log(newBook);
        this.dataService.addBook(newBook).subscribe((data) => console.log(data), err => console.error(err));
    }
};
...
let BooksResolverService = class BooksResolverService {
    ...
    resolve(route, state) {
        return this.dataService.getAllBooks()
            .pipe(
        // another option is to inject the router and navigate the user into another error page
        (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.catchError)(err => (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(err)));
    }
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CACHABEALE": () => (/* binding */ CACHABEALE),
...
const CACHABEALE = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpContextToken(() => true);
let CacheInterceptor = class CacheInterceptor {
    constructor(cacheeService) {
        this.cacheeService = cacheeService;
    }
    intercept(request, next) {
        ...
        const cachedResponse = this.cacheeService.get(request.url);
...
let DataService = class DataService {
    ...
    getAllBooks() {
        return this.http.get('api/books', {
            context: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__.HttpContext().set(_cache_interceptor__WEBPACK_IMPORTED_MODULE_2__.CACHABEALE, false)
        })
    ...
    handleHttpError(err) {
        ...
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_6__.throwError)(dataError);
    }
};
...
let EditBookComponent = class EditBookComponent {
    ...
    ngOnInit() {
        ...
        this.dataService.getBookById(bookID).subscribe((book) => this.selectedBook = book, (err) => console.error(err));
    }
    setMostPopular() {
